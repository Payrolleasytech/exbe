...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Tag: Schema.Attribute.Component<'global.tags', true>;
...
export interface ApiTestContentTestContent extends Struct.SingleTypeSchema {
  collectionName: 'test_contents';
  info: {
    displayName: 'Test Content';
    pluralName: 'test-contents';
    singularName: 'test-content';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::test-content.test-content': ApiTestContentTestContent;
